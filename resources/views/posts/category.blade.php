...
@section('content')
    ...
    <section class="lg:mt-4 mt-14 py-4 flex justify-center items-center">
        <div class="w-full px-6 lg:py-16">  
            <h1 class="font-oswald mb-2 text-2xl">Category : {{ $category }}</h1>
